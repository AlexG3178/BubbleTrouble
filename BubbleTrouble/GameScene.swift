...
class GameScene: SKScene {
    ...
    var bubleCreatingInterval: Double = 5
    ...
    override func didMove(to view: SKView) {
        ...
        bubbleTimer = Timer.scheduledTimer(timeInterval: bubleCreatingInterval, target: self, selector: #selector(createBubble), userInfo: nil, repeats: true)
    }
